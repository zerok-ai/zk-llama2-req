...
export TF_VAR_project_id=zerok-dev
export TF_VAR_key_file=serviceAccount.json
export TF_VAR_region=us-west1-b
export TF_VAR_model=llama2-7b
export TF_VAR_hf_api_token=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
